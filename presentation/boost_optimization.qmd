...
::: {style="font-size: 60%;"}
How much of the variation in the driver data is explained by the driver-level?
If we pick two trips at random, how much of the difference in each feature is because they belong to different drivers?
:::
